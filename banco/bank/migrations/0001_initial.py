# Generated by Django 4.2.1 on 2023-06-05 19:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('C', 'Corrente'), ('S', 'Salário'), ('P', 'Pagamento')], default='C', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('transacao', models.CharField(choices=[('F', 'Transferência'), ('E', 'Empréstimo'), ('P', 'Pix')], default='E', max_length=1)),
                ('valor', models.DecimalField(decimal_places=2, max_digits=10)),
                ('nomeCompleto', models.CharField(max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nome_titular', models.CharField(max_length=255, unique=True)),
